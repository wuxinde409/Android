...
public class MainActivity extends AppCompatActivity {
    ...
    public void countUp(View view) {
        mCount++;
        {
            View se = (View) findViewById(R.id.button_zero);
            se.setBackgroundColor(getColor(android.R.color.holo_purple));
            if (mCount % 2 == 0) {
                View sexy = (View) findViewById(R.id.button_count);
                sexy.setBackgroundColor(getColor(android.R.color.holo_green_light));
            } else {
                View sex = (View) findViewById(R.id.button_count);
                sex.setBackgroundColor(getColor(android.R.color.tertiary_text_light));
            }
        ...
        public void ZERO (View view){
            mCount = 0;
            View sexy = (View) findViewById(R.id.button_zero);
            sexy.setBackgroundColor(getColor(android.R.color.darker_gray));
            if (mShowCount != null)
                mShowCount.setText(Integer.toString(mCount));
        }
