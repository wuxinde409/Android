...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class GeneralPreferenceFragment
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            String str[] = {"Same day messenger serivice", "Next day ground delivery", "Pick up"};
            ListPreference listPreference = (ListPreference) findPreference("example_list2");
            listPreference.setSummary(str[Integer.valueOf(listPreference.getValue())]);
            listPreference.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                @Override
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    preference.setSummary(str[Integer.valueOf(newValue.toString())]);
                    Toast.makeText(getActivity(), str[Integer.valueOf(newValue.toString())], Toast.LENGTH_LONG).show();
                    return true;
                }
            });
        }
