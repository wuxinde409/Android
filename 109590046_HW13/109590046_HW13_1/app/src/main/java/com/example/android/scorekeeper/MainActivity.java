...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mScoreText1.setText(mPreferences.getString("count1","0"));
        mScoreText2.setText(mPreferences.getString("count2","0"));
    ...
    protected void onPause() {
        ...
        preferencesEditor.putString("count1", mScoreText1.getText().toString());
        preferencesEditor.putString("count2", mScoreText2.getText().toString());
