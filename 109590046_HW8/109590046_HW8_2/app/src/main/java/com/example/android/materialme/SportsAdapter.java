...
class SportsAdapter extends RecyclerView.Adapter<SportsAdapter.ViewHolder>  {
    ...
    class ViewHolder extends RecyclerView.ViewHolder
        ...
        public void onClick(View view) {
            ...
            ActivityOptionsCompat options = ActivityOptionsCompat.makeSceneTransitionAnimation((Activity) mContext, mSportsImage, ViewCompat.getTransitionName(mSportsImage));
